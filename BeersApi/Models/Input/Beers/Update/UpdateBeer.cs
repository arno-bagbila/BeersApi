...
namespace BeersApi.Models.Input.Beers.Update
{
   /// <summary>
   /// Updated values for the beer
   /// </summary>
   public class UpdateBeer : IEntity
   {
   ...
   public class UpdateBeerValidator : AbstractValidator<UpdateBeer>
   {
      ...
      public UpdateBeerValidator()
      {
         RuleFor(b => b.Name)
            .NotEmpty()
            .WithMessage(GetNullOrEmptyErrorMessage(nameof(UpdateBeer.Name)))
            .MinimumLength(MinimumLength)
            .MaximumLength(NameMaxLength);

         RuleFor(b => b.Description)
            .NotEmpty()
            .WithMessage(GetNullOrEmptyErrorMessage(nameof(UpdateBeer.Description)))
            .MinimumLength(MinimumLength)
         ...
         RuleFor(b => b.LogoUrl)
            .NotEmpty()
            .WithMessage(GetNullOrEmptyErrorMessage(nameof(UpdateBeer.LogoUrl)))
            .Custom(((s, context) =>
            {
